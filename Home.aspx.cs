...
public partial class Home : System.Web.UI.Page
{
    ...
    {
        SqlDataSource1.SelectCommand = "SELECT * FROM [HangHoa] WHERE ([MALOAI] = '" + "L02" + "') OR ([MALOAI] = '" + "L01" + "')";
        SqlDataSource2.SelectCommand = "SELECT * FROM [HangHoa] WHERE ([MALOAI] = '" + "L03" + "') OR ([MALOAI] = '" + "L04" + "')";
    }
